...
import { useS04SearchPopupController } from './useS04SearchPopupController';

describe('useS04SearchPopupController', () => {
  it('starts closed by default', () => {
    const { result } = renderHook(() => useS04SearchPopupController({ shortcutKey: 'f' }));
  ...
  it('opens from toolbar and requests focus', () => {
    ...
    const { result } = renderHook(() => useS04SearchPopupController({
      shortcutKey: 'f',
      onOpenFromToolbar,
    }));
