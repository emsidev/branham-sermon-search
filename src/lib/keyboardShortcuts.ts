...
export const SHORTCUT_DEFINITIONS: ShortcutDefinition[] = [
  ...
  {
    action: 'toggle_slide_view',
    label: 'Toggle slide view',
    description: 'Enters or exits fullscreen presentation mode for the highlighted text selection.',
  },
  {
    action: 'add_slide_highlight',
    label: 'Add highlight to presentation',
    description: 'Adds the current highlighted text selection to the presentation queue.',
  },
  {
